        ...
        return (
            <div className="film">
                <h4 className="film-title">
                    Episode
                    <span className="film-episode">4</span>:
                    <span className="ext-uppercase film-title">A new hope</span>
                </h4>
                <table className="table table-striped table-hover table-bordered">
                    <tbody>
                        ...
                        <tr className="row">
                            ...
                            <td className="col-8 col-md-9 col-lg-10">Gary Kurtz, Rick McCallum</td>
                        </tr>
                        <tr className="row">
                            <td className="col-4 col-md-3 col-lg-2">Date of reliase:</td>
                            <td className="col-8 col-md-9 col-lg-10">1975-05-25</td>
                        </tr>
                        <tr className="row">
                ...
                <div className="stage">
                    <div className="stage__crawl-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quod eligendi dolorem repellendus? Temporibus, molestias, molestiae, saepe, quae id eveniet iste beatae cum aliquam nihil dolorum debitis dolor quas delectus repellat.
